...
<div class="tabs" role="tablist" aria-label="Onglets du tableau de bord">
  ...
  <button class="tab-btn"       id="btn-gel"     role="tab" aria-selected="false" aria-controls="gel"     data-cible="gel">🌡️ Gel et chaleur</button>
  <button class="tab-btn"       id="btn-stress"  role="tab" aria-selected="false" aria-controls="stress"  data-cible="stress">🐄 Stress thermique</button>
